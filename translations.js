...
const APP_TRANSLATIONS = {
    ...
    fr: {
        ...
        title_session_log: "Journal de la session الحالية",
        th_time: "Heure",
        th_silo: "Silo",
        th_weight: "Poids",
        th_diff: "Différence",
        ...
        stat_max_speed: "Vitesse Max (Inst.)",
        // NOUVEAUX CHAMPS
        stat_avg_speed: "Vitesse Moyenne",
        stat_min_diff: "Différence Min (T)",
        stat_max_diff: "Différence Max (T)",
        th_avg_speed: "Vit. Moy. T/h",
        th_avg_speed_history: "Vitesse Moyenne T/h",
        // FIN NOUVEAUX CHAMPS
    ...
    en: {
        ...
        stat_max_speed: "Max Speed (Inst.)",
        // NEW FIELDS
        stat_avg_speed: "Average Speed",
        stat_min_diff: "Minimum Difference (T)",
        stat_max_diff: "Maximum Difference (T)",
        th_avg_speed: "Avg. Speed T/h",
        th_avg_speed_history: "Average Speed T/h",
        // END NEW FIELDS
    ...
    ar: {
        ...
        stat_max_speed: "أقصى سرعة (لحظية)",
        // الحقول الجديدة المطلوبة
        stat_avg_speed: "السرعة المتوسطة",
        stat_min_diff: "الفرق الأدنى (ط)",
        stat_max_diff: "الفرق الأقصى (ط)",
        th_avg_speed: "متوسط السرعة ط/س",
        th_avg_speed_history: "متوسط السرعة ط/س",
